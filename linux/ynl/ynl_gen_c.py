...
class Family(SpecFamily):
    def __init__(self, file_name, exclude_ops, fn_prefix, schema_path=None):
        # Added by resolve:
        self.c_name = None
        delattr(self, "c_name")
        self.op_prefix = None
        ...
        super().__init__(file_name, schema_path=schema_path,
...
def find_kernel_root(full_path):
    ...
    while True:
        ...
        if full_path == os.path.dirname(full_path):
            return None, os.path.basename(sub_path[:-1])
